<section class="banner">
	...
	<div class="banner-text">
		<div class="container">
			<h1>Educational Platform for Solid Waste Management</h1>
			<p>Join us today. Learn, Contribute and let's make our world a better place</p>
			<!--
			...
			<div class="learning-btn" style="margin-top:105px;">
				<a href="<?=site_url('/Category');?>" class="btn">Get Started</a>
			</div>
		</div>
	</div>
</section>
