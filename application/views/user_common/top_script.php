...
<body>
	<div id="wruper">
		Made In AAUA with <i class="fa fa-heart" style="color:red;"></i>
	</div>
	<div class="wapper">
		<div class="quck-nav">
			<div class="container">
				<div class="contact-no"><a href="#"><i class="fa fa-map-marker"></i>P.M.B 001, Adekunle Ajasin University, Akungba Akoko</a></div>
				<div class="contact-no"><a href="Tel:+23464230801"><i class="fa fa-phone"></i>+23464230801</a></div>
				<div class="contact-no"><a href="mailto:fastnettech01@gmail.com"><i class="fa fa-envelope"></i>fastnettech01@gmail.com</a></div>
