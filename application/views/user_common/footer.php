		...
		<div class="row">
			<div class="col-sm-8">
				<div class="copy-right">
					<p>Copyright © <span class="year">2021</span> Web-Based Educational Platform for Solid Waste Management</p>
					<!--
						<ul class="footer-link">
			...
			<div class="col-sm-4 ">	
				<div class="social-media">
					<ul>
						...
						<li><a href="https://api.whatsapp.com/send?text=Hello, <?=$this->session->UserName?> Here&phone=+23408155931626"><i class="fa fa-whatsapp"></i></a>
						</li>
